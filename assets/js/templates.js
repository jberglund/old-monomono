...
this["Marmelad"]["templates"]["searchtrack"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return '<div class="track__inner">\n' +
            '<img class="track__img" src="' + escapeExpression(((helper = (helper = helpers.artwork_url || (depth0 != null ? depth0.artwork_url : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"artwork_url","hash":{},"data":data}) : helper))) + '">' +
